    ...
    <div className="min-h-screen">
      ...
      <nav className="border-b" style={{ borderColor: "var(--color-border)" }}>
        <div className="max-w-4xl mx-auto px-6 py-4 flex gap-8 items-center">
          ...
          <Link href="/blog" style={{ color: "var(--color-muted)" }} className="nav-link transition-colors">
            Blog
          </Link>
          <Link href="/projects" style={{ color: "var(--color-primary)" }} className="transition-colors">
            Projects
          </Link>
          ...
          <div className="ml-auto flex items-center gap-6">
            ...
            {/* Social Links */}
            <a
              href="https://github.com/cavities12"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/ellen-ma-a61aa9244/"
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: "var(--color-muted)", opacity: 0.7 }}
              aria-label="LinkedIn"
        ...
        <div className="space-y-8">
          ...
          <div className="border rounded-lg p-6" style={{ borderColor: "var(--color-border)" }}>
            <h2 className="text-2xl font-semibold mb-3">
              <a
                href="https://github.com/cavities12/multiturn-rl-agent"
                target="_blank"
                rel="noopener noreferrer"
